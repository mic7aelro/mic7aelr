...
export const greats: Great[] = [
  // ── Top 10 — inferred order, official reveal early July 2026 ──
  ...
  { rank: 3, name: 'Mohamed Salah', pos: 'FW', posName: 'Right winger', nat: 'EGY', era: '2017–2026', note: "The 'Egyptian King' — 2nd all-time scorer with 257 in just 440 games. A cut-inside right winger and penalty machine who fired the 2020 and 2025 titles.", predicted: true },
  { rank: 4, name: 'Ian Rush', pos: 'FW', posName: 'Striker', nat: 'WAL', era: '1980–1996', note: "The club's record goalscorer with 346. A ruthless, relentless-pressing striker whose telepathic link with Dalglish defined the 1980s dynasty.", predicted: true },
  ...
  { rank: 6, name: 'Virgil van Dijk', pos: 'DF', posName: 'Centre-back', nat: 'NED', era: '2018–', note: 'The captain and defensive cornerstone since 2018 — dominant in the air, serene on the ball and quick across the ground. Arguably the best centre-back of his era.', predicted: true },
  { rank: 7, name: 'John Barnes', pos: 'FW', posName: 'Winger', nat: 'ENG', era: '1987–1997', note: 'A mesmeric, gliding winger with electric feet. At his 1987–90 peak the best player in England — two titles plus the 1988 FWA and PFA awards.', predicted: true },
  { rank: 8, name: 'Alan Hansen', pos: 'DF', posName: 'Centre-back', nat: 'SCO', era: '1977–1991', note: 'An elegant, ball-playing centre-half who defended by reading the game rather than by force — the libero of the all-conquering sides, with eight league titles.', predicted: true },
  { rank: 9, name: 'Roger Hunt', pos: 'FW', posName: 'Striker', nat: 'ENG', era: '1959–1969', note: "'Sir Roger' — the club's record league goalscorer and a 1966 World Cup winner. A tireless runner and clinical finisher who powered the Shankly revival.", predicted: true },
  { rank: 10, name: 'Ian Callaghan', pos: 'MF', posName: 'Midfielder', nat: 'ENG', era: '1960–1978', note: "The club's appearance record-holder with 857 games over 18 years — a tireless, impeccably professional winger-turned-midfielder.", predicted: true },

  // ── 11–100 — officially revealed ──
