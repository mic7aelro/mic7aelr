...
type DraftDocument = { owner: string; snapshot: Snapshot; updatedAt: string };
...
export async function GET() {
  ...
  return NextResponse.json({ snapshot: draft?.snapshot || null, updatedAt: draft?.updatedAt || null });
}
